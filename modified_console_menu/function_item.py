...
class FunctionItem(ExternalItem):
    ...
    def __init__(self, text, function, args=None, kwargs=None, menu=None, should_exit=False, menu_char=None, index_item_separator=None):
        """
        ...
        """
        super(FunctionItem, self).__init__(text=text, menu=menu, should_exit=should_exit, menu_char=menu_char, index_item_separator=index_item_separator)
